...
public class PaTotauxDevis extends org.eclipse.swt.widgets.Composite {
	...
	private DecoratedField fieldTX_REM_TTC_DEVIS;
	private DecoratedField fieldMT_HT_CALC;
	private DecoratedField fieldTX_REM_HT_DEVIS;
			...
			}
			{
				...
				}
				{
					...
					if(!decore) {
						...
						fieldTX_REM_HT_DEVIS = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
				...
				}
				{
					...
					if(!decore) {
						...
						fieldTX_REM_TTC_DEVIS = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
...
//	}
	...
	public DecoratedField getFieldTX_REM_TTC_DEVIS() {
	...
	public DecoratedField getFieldTX_REM_HT_DEVIS() {
		return fieldTX_REM_HT_DEVIS;
	}

//	public DecoratedField getFieldREGLE_DEVIS() {
