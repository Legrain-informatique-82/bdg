...
import fr.legrain.devis.divers.IHMLignesTVADevis;
...
public class PaEditorTotauxDevisController extends JPABaseControllerSWTStandard implements 
...
SWTModificationDocumentListener,ChangeModeListener {
	...
	private TaDevisDAO daoLocal = null;
...
//			tableViewer.setInput(writableList);
			...
			LgrViewerSupport.bind(tableViewer, 
					new WritableList(modelLignesTVA.remplirListe(masterEntity), IHMLignesTVADevis.class),
...
//	}
	...
	protected boolean aideDisponible() {
		...
		switch ((PaEditorTotauxDevisController.this.masterDAO.getModeObjet().getMode())) {
