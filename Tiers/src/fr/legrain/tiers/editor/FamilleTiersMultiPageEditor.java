 ...
 * </ul>
 */
public class FamilleTiersMultiPageEditor extends AbstractLgrMultiPageEditor implements 
...
//public class MultiPageEditor extends SharedHeaderFormEditor {
	...
	protected TaFamilleTiersDAO masterDAO = null;
	...
	protected void createPageQueEditeur() {
		try {
			...
			editorFamilleTiers = new EditorFamilleTiers(this,em);
...
//			throw new PartInitException("Invalid Input: Must be IFileEditorInput");
	...
	protected void pageChange(int newPageIndex) {
		...
		if(getActiveEditor() instanceof IEditorFamilleTiersExtension) {
			...
			((ILgrEditor)getActiveEditor()).getController().executeCommand(JPABaseControllerSWTStandard.C_COMMAND_GLOBAL_REFRESH_ID);
		}
//		if(listeEditeurExtension!=null){
//			for (IEditorFamilleTiersExtension editor : listeEditeurExtension) {
//				if(((ILgrEditor)editor).getController()!=null){
