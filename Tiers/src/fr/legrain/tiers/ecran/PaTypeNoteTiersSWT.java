...
public class PaTypeNoteTiersSWT extends fr.legrain.lib.gui.DefaultFrameFormulaireSWT {
	...
	private DecoratedField fieldLABELLE_T_NOTE_TIERS;
...
//							tfLIBL_COMMENTAIRE, tfCODE_BANQUE, tfEntite, composite3 });
	...
	public DecoratedField getFieldLABELLE_T_NOTE_TIERS() {
		return fieldLABELLE_T_NOTE_TIERS;
	}

	public void setFieldLABELLE_T_NOTE_TIERS(DecoratedField fieldLABELLE_T_NOTE_TIERS) {
