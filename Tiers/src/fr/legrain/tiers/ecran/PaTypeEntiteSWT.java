...
public class PaTypeEntiteSWT extends fr.legrain.lib.gui.DefaultFrameFormulaireSWT {
	...
	private DecoratedField fieldCODE_T_ENTITE;
	private DecoratedField fieldLIBL_T_ENTITE;
...
//							tfLIBL_COMMENTAIRE, tfCODE_BANQUE, tfEntite, composite3 });
	...
	public DecoratedField getFieldCODE_T_ENTITE() {
	...
	public DecoratedField getFieldLIBL_T_ENTITE() {
