...
//			new StringFieldEditor(PreferenceConstants.P_DOSSIER_A_SAUVEGARDER, "Dossier à sauvegarder :", getFieldEditorParent()));		
		...
		addField(
				new StringFieldEditor(PreferenceConstants.EMPLACEMENT_SAUVEGARDE_FERMETURE, "Répertoire de destination des sauvegardes exécutées " +
						"automatiquement à la fermeture du dossier :", getFieldEditorParent()));
		addField(
				new BooleanFieldEditor(PreferenceConstants.sauvegardeFermeture, "Autoriser la sauvegarde à la fermeture du dossier :", getFieldEditorParent()));		
	}
