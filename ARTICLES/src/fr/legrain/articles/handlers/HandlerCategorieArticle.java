...
public class HandlerCategorieArticle extends LgrAbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			IEditorPart editor = JPALgrEditorPart.verifEditeurOuvert(EditorTypeCategorieArticle.ID);
			if(editor==null){
			...
			((JPALgrEditorPart)e).getController().configPanel(paramAfficheCategorieArticle);
			} else {
