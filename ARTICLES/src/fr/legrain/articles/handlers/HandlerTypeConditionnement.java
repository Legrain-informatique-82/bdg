...
public class HandlerTypeConditionnement extends LgrAbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			IEditorPart editor = JPALgrEditorPart.verifEditeurOuvert(EditorTypeConditionnement.ID);
			if(editor==null){
				...
				((JPALgrEditorPart)e).getController().configPanel(paramAfficheTypeConditionnement);
			} else {
