...
public class PaFamilleTiers extends fr.legrain.lib.gui.DefaultFrameFormulaireSWT {
	...
	private DecoratedField fieldLIBC_FAMILLE;
	private DecoratedField fieldCODE_FAMILLE;
	private DecoratedField fieldLIBL_FAMILLE;
		...
		try {
			{
				...
				}
				{
					...
					fieldLIBC_FAMILLE = new DecoratedField(paCorpsFormulaire, SWT.BORDER, new TextControlCreator());
				...
				}
				{
					...
					fieldLIBL_FAMILLE = new DecoratedField(paCorpsFormulaire, SWT.BORDER, new TextControlCreator());
	...
	public DecoratedField getFieldLIBC_FAMILLE() {
		return fieldLIBC_FAMILLE;
	}

	public DecoratedField getFieldLIBL_FAMILLE() {
