...
public class PaFournisseurSWT extends fr.legrain.lib.gui.DefaultFrameFormulaireSWT {
	...
	private DecoratedField fieldCodeFournisseur;
		...
		try {
			{
				...
				}
				{
					...
					fieldCodeFournisseur = new DecoratedField(paCorpsFormulaire, SWT.BORDER, new TextControlCreator());
...
//							tfLIBL_COMMENTAIRE, tfCODE_BANQUE, tfEntite, composite3 });
	...
	public DecoratedField getFieldCodeFournisseur() {
