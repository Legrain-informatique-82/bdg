...
public class SWTPaFamilleController extends JPABaseControllerSWTStandard
implements RetourEcranListener {

	static Logger logger = Logger.getLogger(SWTPaFamilleController.class.getName());
	private PaFamilleSWT vue = null;
	private TaFamilleDAO dao = new TaFamilleDAO(getEm());
	...
	private ModelGeneralObjet<SWTFamille,TaFamilleDAO,TaFamille> modelFamille = new ModelGeneralObjet<SWTFamille,TaFamilleDAO,TaFamille>(dao,classModel);
	...
	private LgrDozerMapper<SWTFamille,TaFamille> mapperUIToModel = new LgrDozerMapper<SWTFamille,TaFamille>();
	...
	private void changementDeSelection() {
		if(selectedFamille!=null && selectedFamille.getValue()!=null) {
			if(((SWTFamille) selectedFamille.getValue()).getIdFamille()!=null) {
				taFamille = dao.findById(((SWTFamille) selectedFamille.getValue()).getIdFamille());
			}
...
//	}
		...
		try {
			...
			if(isUtilise())MessageDialog.openInformation(vue.getShell(), MessagesEcran
				...
				if (MessageDialog.openConfirm(vue.getShell(), MessagesEcran
					...
					TaFamille u = dao.findById(((SWTFamille) selectedFamille.getValue()).getIdFamille());
					dao.supprimer(u);
	...
	protected void actImprimer() throws Exception {
		...
		fonctionGetInfosXmlAndProperties.findInfosFileXml(TaFamille.class.getName(),SWTFamille.class.getName(),
				listeChamp,"mapping");
...
//			impression.imprimer(true,pathFileReportDynamic,null,"Famille",TaFamille.class.getSimpleName(),false);
	...
	public IStatus validateUIField(String nomChamp,Object value) {
		String validationContext = "FAMILLE";
		try {
			IStatus s = null;
			int change=0;
	...
	protected void actEnregistrer() throws Exception {
		...
		try {
			...
			if ((dao.getModeObjet().getMode().compareTo(ModeObjet.EnumModeObjet.C_MO_EDITION) == 0)) {
				...
				mapperUIToModel.map((SWTFamille) selectedFamille.getValue(),taFamille);

				dao.enregistrerMerge(taFamille);
...
//				modelFamille.getListeEntity().add(taFamille);
	...
	protected void actRefresh() throws Exception {
		...
		if (dao.getModeObjet().getMode().compareTo(ModeObjet.EnumModeObjet.C_MO_CONSULTATION) == 0) {
			...
			if (taFamille!=null && selectedFamille!=null && (SWTArticle) selectedFamille.getValue()!=null) {
				new LgrDozerMapper<TaFamille, SWTFamille>().
					map(taFamille, (SWTFamille) selectedFamille.getValue());
			}
		}
	...
	public ModelGeneralObjet<SWTFamille,TaFamilleDAO,TaFamille> getModelFamille() {
		return modelFamille;
	}
