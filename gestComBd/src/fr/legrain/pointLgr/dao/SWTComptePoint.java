...
public class SWTComptePoint extends ModelObject {
	...
	private BigDecimal utilise_avis;
	private BigDecimal utilise_facture;
	...
	public static SWTComptePoint copy(SWTComptePoint swtAdresse){
		...
		swtAdresseLoc.setUtilise_avis(swtAdresse.getUtilise_avis());
		swtAdresseLoc.setUtilise_facture(swtAdresse.getUtilise_facture());
	...
	public void setUtilise_avis(BigDecimal utilise_avis) {
		firePropertyChange("utilise_avis", this.utilise_avis, this.utilise_avis = utilise_avis);
	}
	...
	public void setUtilise_facture(BigDecimal utilise_facture) {
		firePropertyChange("utilise_facture", this.utilise_facture, this.utilise_facture = utilise_facture);
	}
	...
	public SWTComptePoint(Integer idPoint, BigDecimal point,
			...
			BigDecimal utilise_avis, BigDecimal utilise_facture) {
		super();
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((utilise_avis == null) ? 0 : utilise_avis.hashCode());
		result = prime * result
				+ ((utilise_facture == null) ? 0 : utilise_facture.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (typeMouv == null) {
			...
			return false;
		if (utilise_avis == null) {
			if (other.utilise_avis != null)
				return false;
		} else if (!utilise_avis.equals(other.utilise_avis))
			return false;
		if (utilise_facture == null) {
			if (other.utilise_facture != null)
				return false;
		} else if (!utilise_facture.equals(other.utilise_facture))
			return false;
		return true;
	}
