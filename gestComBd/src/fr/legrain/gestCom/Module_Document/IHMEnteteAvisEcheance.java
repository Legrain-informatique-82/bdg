...
public class IHMEnteteAvisEcheance extends ModelObject {
	...
	private String codeEtat = LgrConstantes.C_STR_VIDE;
	...
	public IHMEnteteAvisEcheance(Integer idDocument, String codeDocument,
			...
			String commentaire, Boolean accepte, List<IHMLAvisEcheance> lignes , String codeEtat) {
		super();
	...
	public void setIHMEnteteDevis(IHMEnteteAvisEcheance ihmEnteteDevis){
		...
		setCodeEtat(ihmEnteteDevis.codeEtat);
	}
	...
	public static IHMEnteteAvisEcheance copy(IHMEnteteAvisEcheance ihmEnteteDevis){
		...
		ihmEnteteDevisLoc.setCodeEtat(ihmEnteteDevis.codeEtat);
...
//		if(!getEXPORT().equals(false))return false;
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((lignesAvis == null) ? 0 : lignesAvis.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (libelleDocument == null) {
			...
			return false;
		if (lignesAvis == null) {
			if (other.lignesAvis != null)
				return false;
		} else if (!lignesAvis.equals(other.lignesAvis))
			return false;
		if (mtHtCalc == null) {
