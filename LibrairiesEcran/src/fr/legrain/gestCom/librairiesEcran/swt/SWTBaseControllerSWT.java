...
public abstract class SWTBaseControllerSWT extends SWTBaseController{
	
	static Logger logger = Logger.getLogger(SWTBaseControllerSWT.class.getName());
