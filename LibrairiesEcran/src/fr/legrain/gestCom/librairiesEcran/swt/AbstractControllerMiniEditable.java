...
public abstract class AbstractControllerMiniEditable extends JPABaseControllerSWTStandard {
	
	static Logger logger = Logger.getLogger(AbstractControllerMiniEditable.class.getName());	
	...
	public AbstractControllerMiniEditable(){
		
	}
	
	public AbstractControllerMiniEditable(Composite vue, EntityManager em, Map<Control, String> mapComposantChamps) {
