...
public class PaFormPageAffectation extends org.eclipse.ui.forms.editor.FormPage {

	// -- Id et titre du formulaire --
	public static String id = "fr.legrain.document.etat.facture.ecrans.PaFormPage";
	public static String title = "Article à renouveler avec points bonus";
	public static String titleRemonter = "";
	// -- Chemins des icônes --
	...
	// -- Composites --
	protected PaCompositeSectionParamAffectation compositeSectionParam = null;
	protected PaCompositeSectionDocAffectation compositeSectionResultats = null;
	protected PaCompositeSectionComplementaireAffectation compositeSectionComplementaire = null;

	// -- Form Général --
	protected ScrolledForm form = null;
	protected FormToolkit toolkit;

	protected FormPageControllerPrincipalAffectation controllerPage = null;
	 ...
	 * @param title
	 */
	public PaFormPageAffectation(String id, String title) {
		super(id, title);
	...
	public PaFormPageAffectation(FormEditor editor, String id, String title) {
	...
	protected void createSectionParam(FormToolkit toolkit, final ScrolledForm form) {
		...
		compositeSectionParam = new PaCompositeSectionParamAffectation(toolkit.createComposite(sctnParamtresDuTableau),toolkit);
	...
	public void createSectionResultats (FormToolkit toolkit, final ScrolledForm form){
		...
		sctnTableauGauche.setText("Liste des articles à renouveler avec leur point bonus");
		

		compositeSectionResultats = new PaCompositeSectionDocAffectation(toolkit.createComposite(sctnTableauGauche),toolkit);
	...
	public void createSectionComplementaire (FormToolkit toolkit, final ScrolledForm form){
		...
		compositeSectionComplementaire = new PaCompositeSectionComplementaireAffectation(toolkit.createComposite(sctnDocuments),toolkit);
		compositeSectionComplementaire.getLaGrille().setText(" ");
	...
	public PaCompositeSectionParamAffectation getCompositeSectionParam() {
		return compositeSectionParam;
	}

	public PaCompositeSectionDocAffectation getCompositeSectionResultats() {
		return compositeSectionResultats;
	}

	public FormPageControllerPrincipalAffectation getControllerPage() {
		return controllerPage;
	}

	public void setControllerPage(FormPageControllerPrincipalAffectation controllerPage) {
	...
	public PaCompositeSectionComplementaireAffectation getCompositeSectionComplementaire() {
