...
import fr.legrain.pointsbonus.controller.Affectation.FormPageControllerPrincipalAffectation;
import fr.legrain.pointsbonus.controller.Affectation.PaFormPageAffectation;
...
public class FormEditorAffectationArticlePoint extends lgrFormEditor implements ILgrEditor, ILgrRetourEditeur, /*IEditorArticlesExtension,*/IPartListener{

	static Logger logger = Logger.getLogger(FormEditorAffectationArticlePoint.class.getName());
	
	public static final String ID = "fr.legrain.renouvellementPointArticle";
	...
	// FormPage principal
	private PaFormPageAffectation defaultFormPage = null;
	private Map<PaFormPageAffectation,FormPageControllerPrincipalAffectation> listeController = new HashMap<PaFormPageAffectation,FormPageControllerPrincipalAffectation>();
			
	// Constructeur par défaut
	public FormEditorAffectationArticlePoint() {
		super();
	}
	...
	protected void addPages() {
		try {
			...
			defaultFormPage = new PaFormPageAffectation(this, PaFormPageAffectation.id, PaFormPageAffectation.title);
			
			// Création du Controller
			FormPageControllerPrincipalAffectation defautController = new FormPageControllerPrincipalAffectation(defaultFormPage);
	 ...
	 */
	private void liaisonControllerFormPage(FormPageControllerPrincipalAffectation leController, PaFormPageAffectation leFormPage) {
		leFormPage.setControllerPage((FormPageControllerPrincipalAffectation)leController);
			...
			for (int i = 0; i < extensions.length; i++) {
				...
				for (int jj = 0; jj < confElements.length; jj++) {
					try {
						...
						addEditor((PaFormPageAffectation)o,(FormPageControllerPrincipalAffectation)c,editorName,icon);
...
//						}
	...
	private void addEditor(PaFormPageAffectation e, FormPageControllerPrincipalAffectation c, String label) {
		 addEditor(e,c,label,null);
	}
	
	private void addEditor(PaFormPageAffectation e, FormPageControllerPrincipalAffectation controllerPrincipal, String label, ImageDescriptor icon) {
...
//		}
	...
	public String getTitle() {
		return "Renouvellement articles maintenance";
	}
