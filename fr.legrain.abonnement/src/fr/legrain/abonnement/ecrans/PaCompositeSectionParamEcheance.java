...
public class PaCompositeSectionParamEcheance {
	...
	private Button btnTransforme = null;
	...
	public PaCompositeSectionParamEcheance(Composite compo,FormToolkit toolkit) {
		...
		btnTransforme = toolkit.createButton(compo, "même les transformés", SWT.CHECK); //$NON-NLS-1$
		GridData btnNonTransformeGridData = new GridData(SWT.BEGINNING,SWT.NONE,true,false,1,1);
		btnTransforme.setLayoutData(btnNonTransformeGridData);
...
//	}
	...
	public Button getBtnTransforme() {
		return btnTransforme;
	}
}
